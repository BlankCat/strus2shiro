...
.img404 {PADDING-RIGHT: 0px; PADDING-LEFT: 0px; BACKGROUND: url("/styles/images/photoback.gif") no-repeat left top; FLOAT: left; PADDING-BOTTOM: 0px; MARGIN: 0px; WIDTH: 80px; PADDING-TOP: 0px; POSITION: relative; HEIGHT: 90px}
...
您正在搜索的页面可能已经删除、更名或暂时不可用。</h2>
<h3 class=wearesorry></h3>
<div class=content>请尝试以下操作： 
  <ul>
...
<div class=show14>
<ul>
  <li><a title=返回点睛网首页 href="http://www.zfwx.com/">返回点睛网首页</a> </li>
  <li><a title=返回上一个页面 href="javascript:history.back(-1)">返回上一页</a></li>
</ul></div>
要不，我们去<a href="http://wq.zfwlxt.com/" target=_blank>律师学院</a>看看吧~~ </div>
<span 

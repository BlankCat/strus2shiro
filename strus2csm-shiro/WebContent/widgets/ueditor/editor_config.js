...
(function () {
    ...
    var tmp = window.location.pathname;
        //URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","")+"ueditor/";//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    URL= ctx+"/widgets/ueditor/";
    /**
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义 {需要添加涂鸦功能就把'scrawl'添加到toolbars中 'fullscreen',}
        ,toolbars:[
            [ 'source', '|', 'undo', 'redo', '|',
                ...
                'imagecenter', '|', 'insertimage', 'emotion', 'insertvideo', 'attachment', 'map', 'gmap', 'highlightcode','pagebreak','template','background', '|',

...
//            this.width = ($(".popup_content").width());
//            this.height = 530;
        ...
        help: function(elem, title, msg, height,image) {
            this.ID = 'help';
...
//            this.height = height || 120;
        ...
        // 私有方法
        _show: function(elem, msg,image, callback) {
            if ($("#_Popup_" + this.ID).length < 1) {
                //$.popup._hide();
                var html;
                if(image.length==0){
                	
			    html = '<div class="popup_' + this.popType + '" id="_Popup_' + this.ID + '" style="width:' + this.width + 'px">\
                ...
                else
                {
                     ...
                     <div class="popup_header" id="_Title_"><h1>' + this.title + '</h1><div class="h_r"></div></div>\
                     <div class="popup_content">\
                       <div id="_Container_' + this.ID + (this.height == 0 ? '">' : '" style="height:' + this.height + 'px">') + '<img src='+image+' class="img_user" />' + msg +'</div> </div>' +
                       (this.isButtonRow ? '<div class="buttonRow" id="_ButtonRow_' + this.ID + '"></div>' : '') +
                     '<div class="popup_bottom"><div class="b_r"></div>\
                   </div>';
                }
    ...
    showHelper = function(elem, title, msg, height,image) {
        $.popup.help(elem, title, msg, height,image);
    }

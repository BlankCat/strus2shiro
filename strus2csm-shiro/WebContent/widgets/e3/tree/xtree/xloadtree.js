...
webFXTreeConfig.emptyErrorTextTemplate = "";//"��ʾ��Ϣ \"%1%\" û�а��κ� tree ��Ŀ";

/*
 * WebFXLoadTree class
 */

function WebFXLoadTree(sText, sXmlSrc, sAction, sTarget, sBehavior, sIcon, sOpenIcon, sOpen) {
	// call super
...
function WebFXLoadTreeItem(sText, sXmlSrc, sAction, sTarget, eParent, sIcon, sOpenIcon) {
	// call super

...
public interface IBaseDAO<T> {
	 ...
	 * @throws Exception
	 */
	public Page<T> getList(final Page<T> page, final List<PropertyFilter> filters,final JstFetch fetch) throws Exception;
	/**
	 * 分页查询
	 * @param page 分页信息
	 * @param filters 条件过滤
	 ...
	 * @throws Exception
	 */
	public Page<T> getList(Page<T> page, List<PropertyFilter> filters,List<JstFetch> fetchList) throws Exception;
}
